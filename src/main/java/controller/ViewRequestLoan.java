...
@WebServlet("/home/ViewRequestLoan")
public class ViewRequestLoan extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ps = DatabaseConnection.con.prepareStatement("select l.*, lp.path, c.customer_name from Loan l, Account a, Customer c, LoanPath lp where a.branch_id = ? and l.customer_id = c.customer_id and l.loan_id = lp.loan_id and l.loan_status = \"SENT_FOR_REQUEST\" order by applied_date desc");
			...
			if(jsonArray.size() == 1) {
				...
				jsonObject1.put("message", "No Request Available");
